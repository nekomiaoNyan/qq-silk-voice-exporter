...
2. Extract every file and double-click the single launcher, `Start-VoiceConverter.vbs`. It hides the PowerShell/console window and shows only the converter GUI; startup failures are reported in a dialog.
